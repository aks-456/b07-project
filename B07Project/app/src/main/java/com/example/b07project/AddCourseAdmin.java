...
public class AddCourseAdmin extends AppCompatActivity {
    ...
    Button btnAddCourse, btnAddPre, btnAddOff;
    Spinner spPre, spOff;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAddOff = (Button)findViewById(R.id.btnAddOff);
        spOff = (Spinner)findViewById(R.id.spOff);
        ...
        //Course offering sessions
        ArrayList<String> offItems=new ArrayList<String>();
        offItems.add("Choose Offering(s)");
        offItems.add("Winter");
        offItems.add("Summer");
        offItems.add("Fall");

        // use default spinner item to show options in spinner
        ArrayAdapter<String> offAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, offItems);
        spOff.setAdapter(offAdapter);
        ...
        btnAddCourse.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //Change to uid
                writeNewUser(strCourseName, strCourseCode, strPrerequisites, strOfferings);
    ...
    public void writeNewUser(String name, String code, String prerequisites, String offerings) {
